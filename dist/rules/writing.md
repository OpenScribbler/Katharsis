...
Applies to your chat answers, docs, and ticket and wiki bodies, summaries, comments, and
...
them. Good defaults, not hard rules. A direct instruction from me (the user) overrides
anything here.
...
Subagents spawned by the agent tool inherit this file through the `AGENTS.md` import. Output
