...
| `~/.claude/katharsis-data/telemetry/` | Per-reply counts, the model and exchange type, detector rule names, gate misses, and renumbered codes, with no message text | Outlives the plugin |
