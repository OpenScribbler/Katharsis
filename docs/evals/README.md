...
| [Prose headings, before and after](prose-headings.md) | The pair check for proposal 0002: eleven prompts, one per type, under the current style and under the style plus the proposed `## Prose headings` section. Set 1, set 2, and a third round ran, and the section landed in 0.4.0. |
