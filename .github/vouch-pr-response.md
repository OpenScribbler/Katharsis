Thank you for the pull request. Katharsis accepts pull requests from vouched contributors only, and this one is closed because its author is not yet vouched.
...
After that, your pull requests stay open for review. [CONTRIBUTING.md](https://github.com/OpenScribbler/Katharsis/blob/main/CONTRIBUTING.md) covers the checks a pull request has to pass.
