...
- [ ] Every script under `scripts/` still has a suite under `tests/` that asserts exact outputs and exit codes
- [ ] Every hook still exits 0 on every path it cannot help on, and no hook asks for the reply to be written again
